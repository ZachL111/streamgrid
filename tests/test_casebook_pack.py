"""Regression checks for the streamgrid casebook."""
...
from casebook.harness import assert_expected, streamgrid_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(streamgrid_summary(), assert_expected())
