...
`streamgrid` is centered on data engineering work in Java. The technical target is: Demonstrate event-time windows, watermarks, and late-event handling.
...
The score is deterministic. The current threshold is 152. Risk has a penalty of 4, latency has a penalty of 2, and weight contributes a bonus of 4.
